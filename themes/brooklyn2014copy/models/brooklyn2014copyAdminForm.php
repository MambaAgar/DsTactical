...
class brooklyn2014copyAdminForm extends ThemeForm
{
	 ...
	 */
	protected $name = "Brooklyn2014 Copy";
	...
	protected $parent = "brooklyn2014"; //Used when a theme is a copy of another theme to control inheritance
